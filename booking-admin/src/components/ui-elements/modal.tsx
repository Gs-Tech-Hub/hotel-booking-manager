...
export function Modal({ isOpen, onClose, title, content, footer }: ModalProps) {
  ...
  return (
    <div className="fixed top-12 inset-0 z-[9999] flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white dark:bg-gray-dark rounded-lg shadow-lg w-full max-w-lg p-5 relative">
        <button
          onClick={onClose}
          className="absolute top-5 right-5 text-gray-500 hover:text-gray-800 dark:hover:text-white"
        >
          ×
        </button>
